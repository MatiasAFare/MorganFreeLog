...
router.get('/new', checkPermiso('gestionar_usuarios'), userController.showCreateForm);  // Formulario de creación
router.post('/', checkPermiso('gestionar_usuarios'), userController.handleCreate);  // Procesar creación
