...
router.get('/new', checkPermiso('gestionar_permisos'), permisosController.showCreateForm); // Formulario de creación
router.get('/:id/edit', checkPermiso('gestionar_permisos'), permisosController.showEditForm); // Formulario de edición

// ========== ACTION ROUTES (POST) ==========
router.post('/', checkPermiso('gestionar_permisos'), permisosController.handleCreate); // Procesar creación
router.post('/:id/edit', checkPermiso('gestionar_permisos'), permisosController.handleUpdate); // Procesar edición
router.post('/:id/delete', checkPermiso('gestionar_permisos'), permisosController.handleDelete); // Eliminar permiso
